...
class BotonesCensoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Datos Censo', style: TextStyle(color: Colors.white),),
        centerTitle: true,
  ...
  return Table(
      children: [
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.amberAccent, Icons.home, 'Censar vivienda' , 'censo', context),
            _crearBotonRedondeado( Colors.blue, Icons.people, 'Agregar persona a vivienda' , 'buscarPesona', context),
          ]
        ),
      ],
    );
