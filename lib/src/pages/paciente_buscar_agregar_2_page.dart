...
class PacienteBuscarAgregar2Page extends StatefulWidget {
  @override
  _PacienteBuscarAgregar2PageState createState() => _PacienteBuscarAgregar2PageState();
}

class _PacienteBuscarAgregar2PageState extends State<PacienteBuscarAgregar2Page> {
  Future _future;
  ...
  Widget build(BuildContext context) {
    ...
    ScreenArguments parametros = ModalRoute.of(context).settings.arguments;
    Persona2Model persona = parametros.info;
    datosVivienda = parametros.datosVivienda;
    viviendaId=datosVivienda.vivienda.id.toString();

    final DateFormat formatter = DateFormat('dd-MM-yyyy');
    final String fechaNacimiento =
        formatter.format(persona.persona[0].fechaNacimiento);

    print("Estoy en paciente 3 ${persona.persona[0].apellido}");
    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                persona.persona[0].nombre + ' ' + persona.persona[0].apellido,
                style: TextStyle(
                    color: Colors.green,
              ...
              Divider(),
              Text(
                persona.persona[0].numeroDocumento,
                style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.bold,
                    fontSize: 20),
              ...
              Container(
                  ...
                  child: Row(children: <Widget>[
                    Icon(Icons.people),
                    Text(' Sexo: ' + persona.persona[0].sexo,
                        style: TextStyle(color: Colors.black, fontSize: 14))
                  ]
  ...
  Widget _crearAppBar(context) {
    return AppBar(
      ...
      title: Text("Buscar y Agregar Persona"),
      leading: IconButton(
          icon: Icon(Icons.arrow_back),
          onPressed: () {
            bloc.changeProgress(Numero(0));

            Navigator.pushReplacementNamed(context, 'buscarAgregarPersona2',
                arguments: datosVivienda);
          }),
    );
  }


Widget _crearBoton( Persona2Model persona) {
  return Container(
    padding: EdgeInsets.symmetric(vertical: 100),
    child: RaisedButton(
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: 80.0, vertical: 15.0),
          child: Text('Vincular Paciente'),
        ),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5.0)),
        elevation: 0.0,
        color: Colors.green,
        textColor: Colors.white,
        onPressed: () =>insertPersona(context, persona)
        ),
  );
}


  insertPersona(context, Persona2Model persona) async {

    final DateFormat formatter = DateFormat('dd-MM-yyyy');
    final String fechaNacimiento =formatter.format(persona.persona[0].fechaNacimiento);
    //sendData.lat = -25;
    //sendData.lon = -26;
    VisitaProvider visitaProvider = new VisitaProvider();
    mapInsert['vivienda_id'] = int.parse(viviendaId);
     mapInsert['id'] = persona.persona[0].id;
    mapInsert['tipos_documento_id'] = persona.persona[0].tiposDocumentoId;
    mapInsert['pais_origen_documento_id'] = persona.persona[0].paisOrigenDocumentoId;
    mapInsert['nacionalidade_id'] = persona.persona[0].nacionalidadeId;
    mapInsert['numero_documento'] = persona.persona[0].numeroDocumento;
   // mapInsert['fecha_nacimiento'] = fechaNacimiento;
    mapInsert['nombre'] = persona.persona[0].nombre;
    mapInsert['apellido'] = persona.persona[0].apellido;
    mapInsert['sexo'] = persona.persona[0].sexo;
    mapInsert['estados_civile_id'] = persona.persona[0].estadosCivileId;
    mapInsert['relaciones_persona_id'] = persona.persona[0].relacionesPersonaId;
    mapInsert['niveles_educativo_id'] = persona.persona[0].nivelesEducativoId;
    mapInsert['ocupacione_id'] = persona.persona[0].ocupacioneId;
    mapInsert['situaciones_laborale_id'] = persona.persona[0].situacionesLaboraleId;
    mapInsert['niveles_educativo_id'] = persona.persona[0].nivelesEducativoId;


// {tipos_documento_id: 1, pais_origen_documento_id: 5, nacionalidade_id: 1, 
// numero_documento: 4553859, fecha_nacimiento: 2021-08-23, nombre: Juan, apellido: Aranfo, sexo: M, estados_civile_id: 1, relaciones_persona_id: 1,
// niveles_educativo_id: 2, ocupacione_id: 1, situaciones_laborale_id: 1, afecciones: [{afeccione_id: 1}]}
    ...
    if (mensaje == 'ok') {
      if (bloc.personas != null && bloc.personas.length > 0) {
        ...
        PersonaModel p = PersonaModel(
            documento: mapInsert['numero_documento'],
            nombre: mapInsert['nombre'],
            apellido: mapInsert['apellido']);
        personas.add(p);
  ...
  Widget crearBody(BuildContext context) {
    ...
    return FutureBuilder<DatosCensoModel>(
        future: _future,
        builder:
            (BuildContext context, AsyncSnapshot<DatosCensoModel> snapshot) {
          if (snapshot.hasData) {
            ...
            return Container(
              ...
              child: PageView(
                ...
                children: <Widget>[
                 ...
                 //   datos: datos,
                 //   controller: controller,
                   // callback: () => insertPersona(context),
                 // ),
                ],
              ),
  ...
  void actionInsert(context) async{
    mapInsert = null;
      
      DatosViviendaModel datosVivienda = await provider.buscarPaciente(bloc.cedula);

    Navigator.pushReplacementNamed(context, 'viviendapersona',
        arguments: datosVivienda);
  }
...
//                 property: 'tipos_documento_id',
//                 atributo: widget.mapInsert,
//                 listaValor: widget.datos.tiposDocumentos,
//                 valorTomar: ConstantePage.NOMBRE),
//             _item(
//                 etiqueta: 'Pais Origen Documento',
//                 property: 'pais_origen_documento_id',
//                 atributo: widget.mapInsert,
//                 listaValor: widget.datos.paisOrigen,
//                 valorTomar: ConstantePage.NOMBRE),
//             _item(
//                 etiqueta: 'Nacionalidad',
//                 property: 'nacionalidade_id',
//                 atributo: widget.mapInsert,
//                 listaValor: widget.datos.nacionalidades,
//                 valorTomar: ConstantePage.DESCRIPCION),
...
//             textColor: Colors.white,
//             onPressed: () {
//               if (widget.mapInsert['tipos_documento_id'] == null ||
//                   widget.mapInsert['pais_origen_documento_id'] == null ||
//                   widget.mapInsert['nacionalidade_id'] == null) {
//                 AppAlertDialog.error(
//                     context: context,
//                     tittle: 'Tesãira',
...
//       @required List<ItemModel> listaValor,
//       @required valorTomar}) {
//     String texto = "";
...
//   Widget _crearInputFecha(context,
//       {@required String etiqueta,
//       @required String property,
//       @required Map<String, dynamic> atributo}) {
...
//           decoration: InputDecoration(labelText: etiqueta),
//           // onTap: () => _selectDate(context),
//           onSaved: (value) => atributo[property] =
...
//   const Page3(
//       {Key key, this.mapInsert, this.datos, this.controller, this.callback})
//       : super(key: key);
...
//                   property: 'sexo',
//                   atributo: widget.mapInsert,
//                   listaValor: generarListaSexo()),
//               _item(
//                   etiqueta: 'Estado Civil',
//                   property: 'estados_civile_id',
//                   atributo: widget.mapInsert,
//                   listaValor: widget.datos.estadosCiviles,
//                   valorTomar: ConstantePage.NOMBRE),
//               _item(
//                   etiqueta: 'Relacion',
//                   property: 'relaciones_persona_id',
//                   atributo: widget.mapInsert,
//                   listaValor: widget.datos.relacionesPersonas,
//                   valorTomar: ConstantePage.NOMBRE),
//             ],
//           ),
//         ),
...
//             textColor: Colors.white,
//             onPressed: () {
//               if (widget.mapInsert['sexo'] == null ||
//                   widget.mapInsert['estados_civile_id'] == null ||
//                   widget.mapInsert['relaciones_persona_id'] == null) {
//                 AppAlertDialog.error(
//                     context: context,
//                     tittle: 'Tesãira',
//                     desc: 'Todos los campos son obligatorios',
...
//                   property: 'niveles_educativo_id',
//                   atributo: widget.mapInsert,
//                   listaValor: widget.datos.nivelesEducativos,
//                   valorTomar: 'nombre'),
//               _item(
//                   etiqueta: 'Ocupacion',
//                   property: 'ocupacione_id',
//                   atributo: widget.mapInsert,
//                   listaValor: widget.datos.ocupaciones,
//                   valorTomar: 'nombre'),
//               _item(
//                   etiqueta: 'Situacion Laboral',
//                   property: 'situaciones_laborale_id',
//                   atributo: widget.mapInsert,
//                   listaValor: widget.datos.situacionesLaborales,
//                   valorTomar: 'descripcion')
//             ],
//           ),
//         ),
//       ),
...
//             textColor: Colors.white,
//             onPressed: () {
//               if (widget.mapInsert['niveles_educativo_id'] == null ||
//                   widget.mapInsert['ocupacione_id'] == null ||
//                   widget.mapInsert['situaciones_laborale_id'] == null) {
//                 AppAlertDialog.error(
//                     context: context,
//                     tittle: 'Tesãira',
//                     desc: 'Todos los campos son obligatorios',
...
//                     property: 'afecciones',
//                     atributo: widget.mapInsert,
//                     listaValor: widget.datos.afecciones,
//                     valoresAfecciones: valoresAfecciones),
//               ),
//             ),
//           ),
//           Expanded(
