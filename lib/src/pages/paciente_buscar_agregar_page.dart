...
class PacienteBuscarAgregarPage extends StatefulWidget {
  @override
  _PacienteBuscarAgregarPageState createState() => _PacienteBuscarAgregarPageState();
}

class _PacienteBuscarAgregarPageState extends State<PacienteBuscarAgregarPage> {
  Future _future;
  ...
  Widget build(BuildContext context) {
    ...
    Persona2Model persona = ModalRoute.of(context).settings.arguments;
    ...
    print("Estoy en paciente 2 ${persona.persona[0].apellido}");
    ...
    return AppBar(
      ...
      leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.pushReplacementNamed(context, 'buscarAgregarPersona',
                arguments: viviendaId);
          }),
    );
  }
...
// niveles_educativo_id: 2, ocupacione_id: 1, situaciones_laborale_id: 1, afecciones: [{afeccione_id: 1}]}
  ...
  void actionInsert(context) {
    mapInsert = null;
    Navigator.pushReplacementNamed(context, 'pacientePrinc',
        arguments: viviendaId);
  }
