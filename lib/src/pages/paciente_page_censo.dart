...
class PacienteCensoPage extends StatefulWidget {
  @override
  _PacienteCensoPageState createState() => _PacienteCensoPageState();
}

class _PacienteCensoPageState extends State<PacienteCensoPage> {
  ...
  Map<String, Object> argumentosView;
  ...
  Widget build(BuildContext context) {
    argumentosView = ModalRoute.of(context).settings.arguments;
    ...
    return AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            //Navigator.pushReplacementNamed(context, 'viviendapersona', arguments: viviendaId);
  ...
  insertPersona( context) async{
    ...
    mapInsert['vivienda_id'] = (argumentosView['viviendaId']);
  ...
  void actionInsert(context ) async {
    ...
    DatosViviendaModel info = await provider.buscarPaciente(argumentosView['documentoPaciente']);

    Navigator.pushReplacementNamed(context, 'viviendapersona', arguments: info);
  }
