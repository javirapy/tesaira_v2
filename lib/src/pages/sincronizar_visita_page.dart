...
class SincronizarVisitaPage extends StatefulWidget {
  @override
  _SincronizarVisitaPageState createState() => _SincronizarVisitaPageState();
}

class _SincronizarVisitaPageState extends State<SincronizarVisitaPage> {
  VisitaBloc bloc;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text('Sincronizar Visitas'),
      ),
      body: new Container(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return Container(
                              ...
                              child: Text("No hay datos a sincronizar!!", style: new TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 18.0)));
